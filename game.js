...
function preload() {
	...
	this.load.spritesheet('wizard_attack_range', 'assets/wizard Pack/Attack2.png', { frameWidth: 231, frameHeight: 190 });
...
function begining(this_create) {
	...
	game.anims.create({
		...
		key: 'wizard_attack_range_play',
		frames: game.anims.generateFrameNumbers('wizard_attack_range', { start: 0, end: 8 }),
		frameRate: 10,
		repeat: 1
...
function update() {
	...
	if (game_state == "start_menu") {
		...
		if (fire == true) {
			...
			player.anims.play('wizard_attack_range_play', true);
